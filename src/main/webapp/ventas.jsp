...
<html lang="en">
	<head>
		...
		/>
		<!-- Link estilos css Bootstrap -->
		<link rel="stylesheet" href="./estilos/usuarios.css" />
		<!-- Link estilos independientes -->
		<title>Ventas</title>
	</head>
	<body>
		<section>
			...
			<div>
				<label for="codProducto" style="margin: 0px 150px 0px 50px">C�digo Producto</label>
		...
		<!-- Link de alertas independiente -->
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
		<!-- Link de JQuery independiente -->
		<script
